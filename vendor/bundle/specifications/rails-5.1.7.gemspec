...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<activerecord>, ["= 5.1.7"])
      s.add_runtime_dependency(%q<actionmailer>, ["= 5.1.7"])
      s.add_runtime_dependency(%q<activejob>, ["= 5.1.7"])
      s.add_runtime_dependency(%q<actioncable>, ["= 5.1.7"])
      s.add_runtime_dependency(%q<railties>, ["= 5.1.7"])
      ...
      s.add_dependency(%q<activerecord>, ["= 5.1.7"])
      s.add_dependency(%q<actionmailer>, ["= 5.1.7"])
      s.add_dependency(%q<activejob>, ["= 5.1.7"])
      s.add_dependency(%q<actioncable>, ["= 5.1.7"])
      s.add_dependency(%q<railties>, ["= 5.1.7"])
